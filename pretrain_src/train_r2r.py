...
def main(opts):
    ...
    if opts.checkpoint:
        ...
        if opts.init_pretrained == 'roberta':
            ...
            tmp = AutoModel.from_pretrained('/datasets/bevbert/data/datasets/pretrained/xlm-roberta-base')
            ...
            tmp = torch.load('/datasets/bevbert/data/datasets/pretrained/LXMERT/model_LXRT.pth', map_location='cpu')
