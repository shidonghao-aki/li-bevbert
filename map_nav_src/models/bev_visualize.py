...
sim.setNavGraphPath('/datasets/bevbert/bevbert_data_ckpt/datasets/R2R/connectivity')
...
rgb_db = h5py.File('/datasets/bevbert/img_features/mp3d_224x224_vfov90_bgr.hdf5', 'r')
depth_db = h5py.File('/datasets/bevbert/img_features/habitat_224x224_vfov90_depth.hdf5', 'r')
