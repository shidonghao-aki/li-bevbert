...
def parse_args():
    ...
    parser.add_argument('--root_dir', type=str, default='/datasets/bevbert/bevbert_data_ckpt/datasets')
    ...
    # BEV
    parser.add_argument("--bev_rgb_db", default='/datasets/bevbert/img_features/vit_b16_224_clip_patch.hdf5', type=str)
    parser.add_argument("--bev_depth_db", default='/datasets/bevbert/img_features/depth_14x14.hdf5', type=str)
...
def postprocess_args(args):
    ...
    args.img_ft_file = os.path.join('/datasets/bevbert/bevbert_data_ckpt/datasets/R2R/features', ft_file_map[args.features])

    args.connectivity_dir = os.path.join(ROOTDIR, 'R2R', 'connectivity')
    args.scan_data_dir = os.path.join('/datasets/v1/scans')
