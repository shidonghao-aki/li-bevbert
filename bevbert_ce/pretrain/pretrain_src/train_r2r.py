...
def main(opts):
    ...
    if opts.checkpoint:
        ...
        if opts.init_pretrained == 'bert':
            ...
            tmp = torch.load(
                '/datasets/bevbert/data/datasets/pretrained/LXMERT/model_LXRT.pth', 
    ...
    train_nav_db = R2RTextPathData(
        ...
        data_cfg.img_ft_file, data_cfg.dep_ft_file,
        data_cfg.img_grid_file, data_cfg.dep_grid_file,
    ...
    val2_nav_db = R2RTextPathData(
        data_cfg.val_unseen_traj_files,
        data_cfg.img_ft_file, data_cfg.dep_ft_file,
        data_cfg.img_grid_file, data_cfg.dep_grid_file,
        data_cfg.scanvp_cands_file, data_cfg.connectivity_dir,
        image_prob_size=model_config.image_prob_size,
