...
_C.IL.RECOLLECT_TRAINER.gt_file = (
    "/datasets/bevbert/datasets/RxR_VLNCE_v0/{split}/{split}_{role}_gt.json.gz"
)
# -----------------------------------------------------------------------------
# IL: DAGGER CONFIG
# -----------------------------------------------------------------------------
...
_C.MODEL.INSTRUCTION_ENCODER.embedding_file = (
    "/datasets/bevbert/data/datasets/R2R_VLNCE_v1-2_preprocessed/embeddings.json.gz"
)
_C.MODEL.INSTRUCTION_ENCODER.dataset_vocab = (
    "/datasets/bevbert/data/datasets/R2R_VLNCE_v1-2_preprocessed/train/train.json.gz"
)
...
_C.MODEL.DEPTH_ENCODER.ddppo_checkpoint = (
    "/datasets/bevbert/gibson-2plus-resnet50.pth"
)
