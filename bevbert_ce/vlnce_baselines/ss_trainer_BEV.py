...
class RLTrainer(BaseVLNCETrainer):
    ...
    def _initialize_policy(
        ...
        cwp_fn = '/datasets/bevbert/data/wp_pred/check_cwp_bestdist_hfov63' if self.config.MODEL.task_type == 'rxr' else '/datasets/bevbert/data/wp_pred/check_cwp_bestdist_hfov90'
