...
flag2=" --exp_name bevbert
      ...
      NUM_ENVIRONMENTS 4
      TASK_CONFIG.SIMULATOR.HABITAT_SIM_V0.ALLOW_SLIDING True
      EVAL.CKPT_PATH_DIR /datasets/bevbert/bevbert_data_ckpt/ckpts/ckpt.iter9600.pth
...
flag3="--exp_name bevbert
      ...
      NUM_ENVIRONMENTS 4
      TASK_CONFIG.SIMULATOR.HABITAT_SIM_V0.ALLOW_SLIDING True
      INFERENCE.CKPT_PATH /datasets/bevbert/bevbert_data_ckpt/ckpts/ckpt.iter9600.pth
