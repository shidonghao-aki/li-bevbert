DATA_ROOT=/datasets/bevbert/bevbert_data_ckpt/datasets
...
#        --aug /datasets/bevbert/bevbert_data_ckpt/datasets/R2R/annotations/prevalent_aug_train_enc.json \
...
python -m torch.distributed.run --nproc_per_node=$ngpus --master_port=$1 \
       map_nav_src/r2r/main_nav.py $flag  \
       --resume_file /datasets/bevbert/bevbert_data_ckpt/ckpts/r2r_best \
       --test --submit